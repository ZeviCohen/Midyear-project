...
#Gun List:
gun_1 = Gun(None, 50, 200, 3, 1)#Sub machine gun
gun_2 = Gun(None, 5, 500, 10, 1)#Sniper
gun_3 = Gun(None, 5, 500, 10, 1)#Shotgun
gun_4 = Gun(None, 30, 250, 3, 1)#Assault rifle
gun_5 = Gun(None, 50, 200, 3, 1)#Light machine gun
#Special
